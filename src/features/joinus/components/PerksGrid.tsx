...
const PerksGrid = () => {
  return (
    <div className="text-primary grid w-full justify-between gap-[50px] pt-10 pr-10 pb-20 pl-10 lg:grid-cols-3 lg:gap-[100px] lg:pt-10 lg:pr-30 lg:pb-20 lg:pl-30">
      <PerksGridFormat
