...
const Bulletin = () => {
  return (
    <div className="relative mx-auto hidden aspect-4/3 max-w-5xl grid-cols-5 grid-rows-4 gap-6 bg-white p-6 lg:visible lg:grid">
      <div className="bg-surface-faint relative col-span-2 row-span-3 flex justify-center rounded-2xl p-8 hover:cursor-pointer">
        <Image
      ...
      <span className="bg-surface-faint absolute -right-[1rem] z-2 col-start-1 col-end-3 row-start-1 row-end-2 h-[1rem] w-[2rem]" />
      <span className="bg-surface-faint absolute -right-[1rem] bottom-0 z-2 col-start-1 col-end-3 row-start-2 row-end-3 h-[1rem] w-[1rem]" />
      ...
      {/* Most recent (MAIN) */}
      <div className="text-primary bg-surface-faint relative col-span-3 row-span-2 -ml-6 flex flex-col justify-between rounded-2xl p-6 hover:cursor-pointer">
      ...
      {/* MINI 1 */}
      <div className="bg-primary/50 relative col-span-3 row-span-1 flex cursor-pointer flex-col justify-between rounded-2xl bg-[url('/assets/bulletins/article1.webp')] bg-cover bg-center p-6 text-white bg-blend-multiply transition hover:cursor-pointer hover:brightness-90">
      ...
      {/* MINI 2 */}
      <div className="bg-primary/50 relative col-span-3 row-span-1 flex cursor-pointer flex-col justify-between rounded-2xl bg-[url('/assets/bulletins/article2.webp')] bg-cover bg-center p-6 text-white bg-blend-multiply transition hover:cursor-pointer hover:brightness-90">
        <div className="ml-4 flex h-full max-w-[85%] flex-col justify-center font-semibold">
      ...
      {/* Want to see more */}
      <div className="justify-left bg-primary relative col-span-2 row-span-1 flex cursor-pointer items-center rounded-2xl p-6 font-semibold text-white transition hover:cursor-pointer hover:brightness-90">
        <div className="ml-4">
