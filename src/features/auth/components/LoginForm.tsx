    ...
    <div className="w-full">
      ...
      <div className="flex justify-center px-6">
        <div className="px-comfortable shadow-card flex min-h-[527px] w-full max-w-[512px] flex-col gap-[44px] rounded-lg bg-white py-[28px]">
          <h2 className="text-primary text-left text-2xl text-[30px] font-bold">Log In</h2>
          ...
          <div className="gap-roomy flex flex-col">
            ...
            <form onSubmit={handleEmailSignIn} className="flex flex-col gap-[44px]">
              ...
              >
                ...
                <span className="z-dropdown relative">{loading ? "Logging in..." : "Log In"}</span>
              </button>
            </form>
            ...
            <div className="flex flex-col gap-[20px]">
              ...
              <div className="gap-tight flex justify-center">
                ...
                <Link href="/signup" className="text-primary text-[16px] font-light underline">
                  Sign up here
                </Link>
              </div>
            </div>
