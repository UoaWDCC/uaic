...
const Footer = () => {
  return (
    ...
    >
      <div
        className="p-4 w-full grid grid-cols-1 items-start text-center gap-y-8 gap-x-12 px-16 pb-0
      lg:grid-cols-3 pl-12 pr-12
      "
      >
        {/* Col 1 */}
        <div className="flex flex-col items-start">
          ...
          <div className="hidden lg:flex lg:flex-col items-start text-left underline text-[2rem] lg:text-[1.4rem] xl:text-[1.4rem] 2xl:text-[2rem] font-light whitespace-nowrap">
            <h2>Home</h2>
            <h2>About</h2>
            <h2>Events</h2>
            <h2>Investments</h2>
      ...
      <div className="flex justify-between w-full pl-12 pr-12">
        ...
        <h1 className="lg:text-[1.4rem] ">© Copyright 2025 University of Auckland Investment Club</h1>
