    ...
    "Bulletin and Investment Committee Chairperson": [
        {
            ...
            imageSrc:
                "/assets/execs/bulletin-investment/riley-bogard-allan.webp",
        },
        {
            name: "Rohit Guthpe",
    ...
    "Diversity and Inclusion Team": [
        {
            ...
            imageSrc:
                "/assets/execs/diversity-inclusion/cassandra-ekanayake.webp",
        },
        {
            ...
            <div>
                ...
                <div className="text-sm text-darkBlue mt-[1em]">
                    <p className="mb-4 pl-4">
                        The Executive Committee is responsible for running the
                        club, including:
                    </p>
                    <ul className="list-disc list-inside mb-4 pl-6">
                        <li>
                            Running competitions, educational events, social
                            events and club-wide initiatives
                        </li>
                        <li>Regularly communicating with our members</li>
                        <li>
                            Managing the Investment Committee and Bulletin
                            Committee
                        </li>
                    </ul>
