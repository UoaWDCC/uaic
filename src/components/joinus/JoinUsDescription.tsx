  ...
  return (
    <>
      ...
      <div className="pl-3 pr-3 sm:pl-10 sm:pr-10">
        <h1 className="mt-2 px-4 md:pl-10 text-[19px] md:text-[20px] font-bold text-darkBlue">
          Join Us
        </h1>
        <hr className="mx-auto w-[95%] border-t border-grey-200" />

        {/* Join Us Description */}
        <div className="mt-6 px-4 md:pl-10 self-center text-sm md:text-[13px] font-normal leading-relaxed text-darkBlue">
          <p>
